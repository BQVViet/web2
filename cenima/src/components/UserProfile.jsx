...
const UserProfile = ({ onProfileUpdate, onFilterChange }) => {
  ...
  return (
    <div className="user-profile-page container">
      <div className="breadcrumb" style={{ padding: '20px 0', fontSize: '14px', color: '#666' }}>
        ...
        <span style={{color: '#222', fontWeight: 'bold'}}> Tài khoản CGV</span>
      </div>

      <div className="section-title" style={{ borderBottom: '2px solid #222', marginBottom: '30px' }}>
        ...
        <div className="profile-main-content">
          <div className="content-box">
            <h2 className="content-title">
              {activeTab === 'profile' ? 'THÔNG TIN CHUNG' : 'ĐỔI MẬT KHẨU'}
            </h2>
